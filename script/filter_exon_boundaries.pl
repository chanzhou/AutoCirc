...
while($line=<IF>){
#chr10	103432670	103436195	chr10junc35	1	+	3	3524	HWI-D00449:117:HVGGKADXX:1:2216:6375:97086	NM_022039	-	9	747,142,141,66,95,133,186,96,606	103370420,103371384,103372093,103384501,103427642,103432671,103433244,103436097,103454137,	FBXW4
	chomp($line);
	...
	my $gid=$fields[9];
	my $gstrand=$fields[10];
	my $exon_num=$fields[11];
	my @exon_sizes=split /\,/, $fields[12];
	my @exon_starts=split /\,/, $fields[13];
